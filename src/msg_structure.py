...
def slice_to_list_pipeline(agent: Agent, original_table: np.array) -> list:
    """
    ...
    length = optimization.optimize_size(original_table, agent.comp_speed, step)
...
def slice_to_list(agent: Agent, original_table: np.array) -> list:
    """
